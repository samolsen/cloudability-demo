...
describe DirectorsController do
  ...
  def valid_attributes
    FactoryGirl.attributes_for(:director)
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved director as @director" do
        ...
        post :create, {:director => { "name" => "invalid value" }}, valid_session
        assigns(:director).should be_a_new(Director)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested director" do
        ...
        Director.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => director.to_param, :director => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the director as @director" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Director.any_instance.stub(:save).and_return(false)
        put :update, {:id => director.to_param, :director => { "name" => "invalid value" }}, valid_session
        assigns(:director).should eq(director)
      end
